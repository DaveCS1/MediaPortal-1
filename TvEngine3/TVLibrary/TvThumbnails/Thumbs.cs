...
namespace TvThumbnails
{
  ...
  public class Thumbs
  {
    ...
    private static bool _sharePreview;

    private static string _recTvThumbsFolder;
    ...
    public static void LoadSettings()
    {
      try
      {
        ...
        _enableThumbCreation = Convert.ToBoolean(layer.GetSetting("TVThumbnails", "true").Value);

        _sharePreview = Convert.ToBoolean(layer.GetSetting("TVThumbnailsSharePreview", "false").Value);
        ...
        switch (configQuality)
        {
          case 0:
            ...
            Log.Info("Thumbs: MediaPortal is using the fastest thumbnail mode");
            break;
          case 1:
          ...
          case 4:
            ...
            Log.Info("Thumbs: MediaPortal is using highest quality thumbnail mode");
            break;
        }
      }
      catch (Exception ex)
    ...
    public static void CreateFolders()
    {
      try
      {
        FileInfo fileInfo = new FileInfo(PathManager.GetDataPath);
        _recTvThumbsFolder = fileInfo.DirectoryName + "\\thumbs";
    ...
    public static bool SharePreview
    {
      get { return _sharePreview; }
    }
